...
const Form = () => {
  ...
  const onSubmit = (event) => {
      ...
      } else if ((valueA === moodQuestions.Hopeless && valueB === moodChangeQuestions.Affirmation) ||
      (valueA === moodQuestions.Inspired && valueB === moodChangeQuestions.Transformation)) {
        getPoem('61f59268a14dceabb9ca0de7');
      } else if ((valueA === moodQuestions.Apathetic && valueB === moodChangeQuestions.Affirmation) ||
      (valueA === moodQuestions.Melancholy && valueB === moodChangeQuestions.Transformation)) {
        getPoem('6274783962fbf3ce518602b0')
      } else if (valueA === moodQuestions.Joyous && valueB === moodChangeQuestions.Affirmation) {
        getPoem('61f8963f3838e139becc6618');
      } else if (valueA === moodQuestions.Apathetic && valueB === moodChangeQuestions.Transformation) {
        getPoem('624c4d9120e5f8823bd99544');
      } else if ((valueA === moodQuestions.Angry && valueB === moodChangeQuestions.Affirmation) ||
      (valueA === moodQuestions.Content && valueB === moodChangeQuestions.Transformation) ||
      (valueA === moodQuestions.Empowered && valueB === moodChangeQuestions.Transformation)) {
        getPoem('625190cf950f9acf1fabf702');
      } else if (valueA === moodQuestions.Angry && valueB === moodChangeQuestions.Transformation) {
        getPoem('62747ba262fbf3ce518602b1');
      } else if (valueA === moodQuestions.Anxious && valueB === moodChangeQuestions.Transformation) {
      ...
      else if (valueA === moodQuestions.Empowered && valueB === moodChangeQuestions.Affirmation) {
